  ...
  <div class="col-sm-12">
    <div class="page-header"> 
      ...
      <ul class="breadcrumb">
        ...
        <li> <i class="fa fa-table"></i> <a href="<?php echo site_url(ADMIN_DIR."questions/view/"); ?>"><?php echo $this->lang->line('Questions'); ?></a> </li>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="pull-right"> <a class="btn btn-primary btn-sm" href="<?php echo site_url(ADMIN_DIR."questions/add"); ?>"><i class="fa fa-plus"></i> <?php echo $this->lang->line('New'); ?></a> <a class="btn btn-danger btn-sm" href="<?php echo site_url(ADMIN_DIR."questions/trashed"); ?>"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('Trash'); ?></a> </div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="box border blue" id="messenger">
      ...
      <div class="box-body">
        <?php
                ...
                echo form_open_multipart(ADMIN_DIR."questions/save_data", $add_form_attr);
            ?>
        <div class="form-group">
          ...
          <?php echo form_error("class_id", "<p class=\"text-danger\">", "</p>"); ?> </div>
        <div class="form-group">
          <?php
                    $label = array(
                        "class" => "col-md-2 control-label",
          ...
          <div class="col-md-10">
            <?php
                    echo form_dropdown("subject_id", $subjects, "", "class=\"form-control\" required style=\"\"");
                    ?>
          </div>
          <?php echo form_error("subject_id", "<p class=\"text-danger\">", "</p>"); ?> </div>
        <div class="form-group">
          <?php
                    $label = array(
                        "class" => "col-md-2 control-label",
          ...
          <div class="col-md-10">
            <?php 
                    ...
                    ?>
            <?php echo form_error("question_type", "<p class=\"text-danger\">", "</p>"); ?> </div>
        </div>
        <div class="form-group">
          <?php
                    $label = array(
          ...
          <div class="col-md-10">
            <?php 
                    ...
                    ?>
            <?php echo form_error("chapter_name", "<p class=\"text-danger\">", "</p>"); ?> </div>
        </div>
        <div class="form-group">
          <?php
                    $label = array(
          ...
          <div class="col-md-10">
            <?php
                    ...
                    $textarea = array(
                        ...
                        "rows"          =>  "",
                        "cols"          =>  "",
                        "value"         => set_value("question_title"),
                        "placeholder"   =>  $this->lang->line('question_title')
                    );
                    echo form_textarea($textarea);
                ?>
            <?php echo form_error("question_title", "<p class=\"text-danger\">", "</p>"); ?> </div>
        </div>
        <div class="form-group">
          <?php
                    $label = array(
                        "class" => "col-md-2 control-label",
                        "style" => "",
                    ); echo form_label($this->lang->line('question_image'), "question_image", $label);      ?>
          <div class="col-md-10">
            <?php
                    ...
                    $file = array(
                        ...
                        "value"         =>  set_value("question_image"),
                        "placeholder"   =>  $this->lang->line('question_image')
                    );
                    echo  form_input($file);
                ?>
            <?php echo form_error("question_image", "<p class=\"text-danger\">", "</p>"); ?> </div>
        </div>
        <div class="form-group">
          <?php
                    $label = array(
          ...
          <div class="col-md-10">
            <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("option_one"),
                        "placeholder"   =>  $this->lang->line('option_one')
                    );
                    echo  form_input($text);
                ?>
            <?php echo form_error("option_one", "<p class=\"text-danger\">", "</p>"); ?> </div>
        </div>
        <div class="form-group">
          <?php
                    $label = array(
          ...
          <div class="col-md-10">
            <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("option_two"),
                        "placeholder"   =>  $this->lang->line('option_two')
                    );
                    echo  form_input($text);
                ?>
            <?php echo form_error("option_two", "<p class=\"text-danger\">", "</p>"); ?> </div>
        </div>
        <div class="form-group">
          <?php
                    $label = array(
          ...
          <div class="col-md-10">
            <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("option_three"),
                        "placeholder"   =>  $this->lang->line('option_three')
                    );
                    echo  form_input($text);
                ?>
            <?php echo form_error("option_three", "<p class=\"text-danger\">", "</p>"); ?> </div>
        </div>
        <div class="form-group">
          <?php
                    $label = array(
          ...
          <div class="col-md-10">
            <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("option_four"),
                        "placeholder"   =>  $this->lang->line('option_four')
                    );
                    echo  form_input($text);
                ?>
            <?php echo form_error("option_four", "<p class=\"text-danger\">", "</p>"); ?> </div>
        </div>
        <div class="form-group">
          <?php
                    $label = array(
          ...
          <div class="col-md-10">
            <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("qustion_correct_answer"),
                        "placeholder"   =>  $this->lang->line('qustion_correct_answer')
                    );
                    echo  form_input($text);
                ?>
            <?php echo form_error("qustion_correct_answer", "<p class=\"text-danger\">", "</p>"); ?> </div>
        </div>
