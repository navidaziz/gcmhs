        ...
        <?php if($count<=30){ 
		     /* $query="INSERT INTO `student_section_history`(`student_id`, `section_id`, `exam_id`) 
			  ...
			  /*$query="INSERT INTO `student_section_history`(`student_id`, `section_id`, `exam_id`) 
			   ...
			   $query="UPDATE `students` SET 
			  `student_class_no` = '".$class_no_two."', `section_id` = '2' WHERE `student_id` = ".$student->student_id;
			  $this->db->query($query);*/
              ...
              <td>'.$student->pass_fail_status.'</td>--></tr>';
			   ...
			   $query="UPDATE `students` SET 
			  `student_class_no` = '".$class_no_three."', `section_id` = '3' WHERE `student_id` = ".$student->student_id;
			  $this->db->query($query);*/
