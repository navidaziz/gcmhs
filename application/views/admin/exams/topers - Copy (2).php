...
table, th, td {
    border: 1px solid black;
        ...
        <h1> <?php echo $exam->year." ".$exam->term." Term "." Exam"; ?>, Class and Section Wise Top Three Students List </h1>
        <table class="table table-bordered">
          ...
          <tr >
            <?php 
			$count =1;
			$top_student_table='<table class="table table-bordered">
			 <h5>'.$class->Class_title.' Class Top Three Students</h5>
                  <tr>
                    <th>#</th>
                    <th>Student Name</th>
                    <!--<th>Class</th>-->
            ...
            <td ><?php echo $top_student_table; ?></td>
            <?php foreach($class->sections as $section_name => $section_top_threes){ ?>
            <td ><h5>Class <?php echo $class->Class_title; ?> - <?php echo $section_name; ?> Top Three Students</h5>
