...
table, th, td {
 ...
 @media print {
   * { color: black; background: white;  !important; font-family: "Segoe UI", Frutiger, "Frutiger Linotype", "Dejavu Sans", "Helvetica Neue", Arial, sans-serif;  }
   table { font-size: 80%; }
   table {
    border-collapse: collapse;
}
...
document.title = "Award List Class <?php echo $class_name; ?> (<?php echo $section_title; ?>)   <?php echo $exam->term. " ".$exam->year  ?>";
	   ...
	   Award List Class <?php echo $class_name; ?> (<?php echo $section_title; ?>)   <?php echo $exam->term. " ".$exam->year  ?> 
            ...
            <tr>
              ...
              <?php } ?>
              <th>Obtaion Mar. (<?php echo $total_subject_marks; ?>)</th>
              <th>%</th>
              <td>Remarks</td>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
             ...
             style="text-align:center; font-style:oblique; font-weight:bold;
...
<!--<table class="table table-border" cellspacing="0" width="48%" style="text-align:center !important; float:right;">
      ...
      <br />
       ...
       <td style="border:0px !important">
           <strong >GCMHS Boys Chitral <br />Exam Committee</strong></td>
...
.dt-button, .buttons-print { display: none; }
</style>
</div>
</body>
</html>
