	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."testimonials/update_data/$testimonial->testimonial_id", $edit_form_attr);
            ?>
            <?php echo form_hidden("testimonial_id", $testimonial->testimonial_id); ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("client_name", $testimonial->client_name),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("client_designation", $testimonial->client_designation),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $textarea = array(
                        ...
                        "rows"          =>  "",
                        "cols"          =>  "",
                        "value"         => set_value("statement", $testimonial->statement),
            ...
            <div class="form-group">
                ...
                <?php
                    $label = array(
                        "class" => "col-md-2 control-label",
                        "style" => "",
                    );  echo form_label($this->lang->line('image')."<br />".file_type(base_url("assets/uploads/".$testimonial->image)), "image", $label);     ?>
                ...
                <?php
                    ...
                    $file = array(
                        ...
                        "value"         =>  set_value("image", $testimonial->image),
                        "placeholder"   =>  $this->lang->line('image')
                    );
                    echo  form_input($file);
                ?>
                    <!--<?php echo file_type(base_url("assets/uploads/$testimonial->image")); ?>-->
