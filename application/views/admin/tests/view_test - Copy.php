	...
	function change_state(question_id){
		...
		$.ajax({ type: "POST",
            ...
            <tbody>
			  ...
			  if(in_array($question->question_id, $test_question_ids)){ ?>
              
              <input type="checkbox" name="question_id" id="question_id_<?php echo $question->question_id; ?>" value="<?php echo $question->question_id; ?>" checked onchange="change_state(<?php echo $question->question_id; ?>)">
              
             <?php  }else{ ?>
              
               <input type="checkbox" name="question_id" value="<?php echo $question->question_id; ?>" onchange="change_state(<?php echo $question->question_id; ?>)">
              <?php } ?></td>
				...
				echo "<br /><strong>1. ".$question->option_one."    2. ".$question->option_two."    3.".$question->option_three."   4.".$question->option_three."</strong>";
				?>
