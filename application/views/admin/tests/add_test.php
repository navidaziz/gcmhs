            ...
            <div class="form-group">
                ...
                <?php
                    $label = array(
                        "class" => "col-md-2 control-label",
                        "style" => "",
                    ); echo form_label($this->lang->line('test_title'), "test_title", $label);      ?>
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "id"            =>  "test_title",
                        "class"         =>  "form-control",
                        "style"         =>  "","required"	  => "required","title"         =>  $this->lang->line('test_title'),
                        "value"         =>  set_value("test_title"),
                        "placeholder"   =>  $this->lang->line('test_title')
                    );
                    echo  form_input($text);
                ?>
                <?php echo form_error("test_title", "<p class=\"text-danger\">", "</p>"); ?>
                </div>
            ...
            <div class="form-group">
                ...
                <?php
                    $label = array(
                        "class" => "col-md-2 control-label",
                        "style" => "",
                    ); echo form_label($this->lang->line('test_discription'), "test_discription", $label);      ?>
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "id"            =>  "test_discription",
                        "class"         =>  "form-control",
                        "style"         =>  "","required"	  => "required","title"         =>  $this->lang->line('test_discription'),
                        "value"         =>  set_value("test_discription"),
                        "placeholder"   =>  $this->lang->line('test_discription')
                    );
                    echo  form_input($text);
                ?>
                <?php echo form_error("test_discription", "<p class=\"text-danger\">", "</p>"); ?>
                </div>
