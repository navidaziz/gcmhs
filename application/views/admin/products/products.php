...
<th><?php echo $this->lang->line('product_main_image'); ?></th>
...
<th><?php echo $this->lang->line('product_brand_title'); ?></th><th><?php echo $this->lang->line('Status'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            <td>
                <?php echo $product->product_brand_title; ?>
                                ...
                                <td>
                                    <?php echo status($product->status,  $this->lang); ?>
                                    <?php
                                        ...
                                        if($product->status == 0){
                                            echo "<a href='".site_url(ADMIN_DIR."products/publish/".$product->product_id."/".$page)."'> &nbsp;".$this->lang->line('Publish')."</a>";
                                        }elseif($product->status == 1){
                                            echo "<a href='".site_url(ADMIN_DIR."products/draft/".$product->product_id."/".$page)."'> &nbsp;".$this->lang->line('Draft')."</a>";
                                        }
                                    ?>
                                </td>
                                <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."products/view_product/".$product->product_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-edit" href="<?php echo site_url(ADMIN_DIR."products/edit/".$product->product_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-pencil-square-o"></i></a>
                                <a class="llink llink-trash" href="<?php echo site_url(ADMIN_DIR."products/trash/".$product->product_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-trash-o"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
