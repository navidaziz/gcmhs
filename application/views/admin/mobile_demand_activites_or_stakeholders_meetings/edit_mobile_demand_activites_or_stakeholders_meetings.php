	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."mobile_demand_activites_or_stakeholders_meetings/update_data/$mobile_demand_activites_or_stakeholders_meetings->m_d_a_or_s_m_id", $edit_form_attr);
            ?>
            <?php echo form_hidden("m_d_a_or_s_m_id", $mobile_demand_activites_or_stakeholders_meetings->m_d_a_or_s_m_id); ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("id", $mobile_demand_activites_or_stakeholders_meetings->id),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("meeting_id", $mobile_demand_activites_or_stakeholders_meetings->meeting_id),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("stakeholder_or_activity_type_id", $mobile_demand_activites_or_stakeholders_meetings->stakeholder_or_activity_type_id),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("meeting_demand_id", $mobile_demand_activites_or_stakeholders_meetings->meeting_demand_id),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("user_id", $mobile_demand_activites_or_stakeholders_meetings->user_id),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("stakeholder_and_activty", $mobile_demand_activites_or_stakeholders_meetings->stakeholder_and_activty),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("stakehoder_rating", $mobile_demand_activites_or_stakeholders_meetings->stakehoder_rating),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("stakeholder_and_activity_detail", $mobile_demand_activites_or_stakeholders_meetings->stakeholder_and_activity_detail),
