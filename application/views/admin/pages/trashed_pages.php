...
<th><?php echo $this->lang->line('page_keywords'); ?></th>
            ...
            <td>
                <?php echo $page->page_keywords; ?>
                            ...
                            <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."pages/view_page/".$page->page_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR."pages/restore/".$page->page_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR."pages/delete/".$page->page_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
