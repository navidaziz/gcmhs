	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."slider_banners/save_data", $add_form_attr);
            ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("slider_banner_title"),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("slider_banner_sub_title"),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $textarea = array(
                        ...
                        "rows"          =>  "",
                        "cols"          =>  "",
                        "value"         => set_value("slider_banner_detail"),
            ...
            <div class="form-group">
                ...
                <?php
                    $label = array(
                        "class" => "col-md-2 control-label",
                        "style" => "",
                    ); echo form_label($this->lang->line('slider_banner_image'), "slider_banner_image", $label);      ?>
                ...
                <?php
                    ...
                    $file = array(
                        ...
                        "value"         =>  set_value("slider_banner_image"),
