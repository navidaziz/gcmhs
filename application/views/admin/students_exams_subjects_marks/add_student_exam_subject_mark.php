	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."students_exams_subjects_marks/save_data", $add_form_attr);
            ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <?php
                    echo form_dropdown("exam_id", $exams, "", "class=\"form-control\" required style=\"\"");
                    ?>
                </div>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("class_subjec_id"),
