...
<th><?php echo $this->lang->line('student_name'); ?></th>
            ...
            <td>
                <?php echo $student_exam_subject_mark->student_name; ?>
                            ...
                            <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."students_exams_subjects_marks/view_student_exam_subject_mark/".$student_exam_subject_mark->student_exam_subject_mark_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR."students_exams_subjects_marks/restore/".$student_exam_subject_mark->student_exam_subject_mark_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR."students_exams_subjects_marks/delete/".$student_exam_subject_mark->student_exam_subject_mark_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
