<form id="teachers" class="form-horizontal" enctype="multipart/form-data" method="post">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input placeholder="MA, BC, FC, M.Phil, Phd" type="text" required id="acadmic_qualification" name="acadmic_qualification" value="<?php echo $input->acadmic_qualification; ?>" class="form-control">
        </div>
    </div>
    <div class="form-group row">
        <label for="major_subject" class="col-sm-4 col-form-label">Major Subject</label>
        <div class="col-sm-8">
            <input placeholder="Urdu, English, Math etc" type="text" required id="major_subject" name="major_subject" value="<?php echo $input->major_subject; ?>" class="form-control">
        </div>
    </div>
    <div class="form-group row">
        <label for="professional_qualification" class="col-sm-4 col-form-label">Professional Qualification</label>
        <div class="col-sm-8">
            <input placeholder="PST, CT, B.Ed, M.Ed" type="text" required id="professional_qualification" name="professional_qualification" value="<?php echo $input->professional_qualification; ?>" class="form-control">
        </div>
    </div>
    <div class="form-group row">
