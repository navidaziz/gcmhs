          ...
          <table class="table table-striped">
            <thead>
              <tr>
                ...
                <th><?php echo $this->lang->line('manager_title'); ?></th>
                <th><?php echo $this->lang->line('manager_role_title'); ?></th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php  echo file_type(base_url("assets/uploads/".$user->user_image)); ?></td>
                <td><?php echo $user->manager_title; ?></td>
                <td><?php echo $user->manager_role_title; ?></td>
               
                <td><?php echo status($user->status,  $this->lang); ?>
                  <?php
                                    ...
                                    ?></td>
                <td><a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."users/view_user/".$user->user_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-eye"></i> </a> <a class="llink llink-edit" href="<?php echo site_url(ADMIN_DIR."users/edit/".$user->user_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-pencil-square-o"></i></a> <a class="llink llink-trash" href="<?php echo site_url(ADMIN_DIR."users/trash/".$user->user_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-trash-o"></i></a></td>
              </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
