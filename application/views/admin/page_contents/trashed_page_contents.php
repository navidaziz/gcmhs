...
<th><?php echo $this->lang->line('page_name'); ?></th>
            ...
            <td>
                <?php echo $page_content->page_name; ?>
                            ...
                            <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."page_contents/view_page_content/".$page_content->page_content_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR."page_contents/restore/".$page_content->page_content_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR."page_contents/delete/".$page_content->page_content_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
