...
<body class="login" style="background: url'(https://scontent.fisb6-1.fna.fbcdn.net/v/t1.0-9/1001843_603742406316406_127595203_n.jpg?_nc_cat=106&_nc_ht=scontent.fisb6-1.fna&oh=d47bfdde3215682dca90a39941b3d681&oe=5CE58686) !important;">
  <!-- PAGE -->
  <section id="page">
    <!-- HEADER -->
    <header>
        ...
        <div class="row">
          <div class="col-md-7 hidden-sm">
            <div style=" text-align:center !important">
              <img class="" src="<?php echo site_url("assets/uploads/" . $system_global_settings[0]->sytem_admin_logo); ?>" alt="<?php echo $system_global_settings[0]->system_title ?>" title="<?php echo $system_global_settings[0]->system_title ?>" weight="100">
