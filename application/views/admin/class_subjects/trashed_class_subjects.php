...
<th><?php echo $this->lang->line('subject_title'); ?></th>
            ...
            <td>
                <?php echo $class_subject->subject_title; ?>
                            ...
                            <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."class_subjects/view_class_subject/".$class_subject->class_subject_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR."class_subjects/restore/".$class_subject->class_subject_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR."class_subjects/delete/".$class_subject->class_subject_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
