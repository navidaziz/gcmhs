...
<th><?php echo $this->lang->line('kpi_title'); ?></th>
            ...
            <td>
                <?php echo $evaluation->kpi_title; ?>
                            ...
                            <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."evaluations/view_evaluation/".$evaluation->evaluation_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR."evaluations/restore/".$evaluation->evaluation_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR."evaluations/delete/".$evaluation->evaluation_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
