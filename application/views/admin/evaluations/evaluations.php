...
<th><?php echo $this->lang->line('kpi_title'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
            ...
            <td>
                <?php echo $evaluation->kpi_title; ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."evaluations/view_evaluation/".$evaluation->evaluation_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-edit" href="<?php echo site_url(ADMIN_DIR."evaluations/edit/".$evaluation->evaluation_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-pencil-square-o"></i></a>
                                <a class="llink llink-trash" href="<?php echo site_url(ADMIN_DIR."evaluations/trash/".$evaluation->evaluation_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-trash-o"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
