	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <?php
                    echo form_dropdown("class_id", $classes, $student->class_id, "class=\"form-control\" required style=\"\"");
                    ?>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <?php
                    echo form_dropdown("section_id", $sections, $student->section_id, "class=\"form-control\" required style=\"\"");
                    ?>
                </div>
