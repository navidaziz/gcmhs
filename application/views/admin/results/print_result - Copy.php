    ...
    <div class="box border blue" id="messenger">
      ...
      <div class="box-body">
        <div class="table-responsive"> 
		  ...
		  foreach($all_results as $class => $sections){ 
		  
		foreach($sections as $section => $results){
			
			$printId= $print_id++."_print";
			 ?>
          <table  id="<?php echo $printId ?>"  class="table table-bordered" style="font-size:15px !important; color:#000 !important; width:100%; border:1px solid red; text-align:center !important">
            <thead>
              <tr>
                <th colspan="17"> <h3 style="text-align:center"><?php echo 'Class  '.$class.' ( '.$section.' ) Year '.$results[0]->session. ' Annual Results'; ?> <span class="pull-right" style="font-size:12px"><a class="btn btn-small btn-default pull-right" id="print_button" onClick="javascript:printData('<?php echo $printId ?>');"> <i class="fa fa-print"></i> Print</a></span> </h3>
                </th>
              </tr>
              <tr style="border:1px solid #666 !important;">
                ...
                <th><?php echo $this->lang->line('general_science'); ?></th>
