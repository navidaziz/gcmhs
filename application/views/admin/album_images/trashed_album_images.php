...
<th><?php echo $this->lang->line('album_title'); ?></th>
            ...
            <td>
                <?php echo $album_image->album_image_id; ?>
            </td>
            <td>
                <?php echo $album_image->gallery_id; ?>
            </td>
            <td>
                <?php echo $album_image->image_detail; ?>
            </td>
            <td>
            <?php
            ...
            <td>
                <?php echo $album_image->album_title; ?>
            </td>
                            
                            <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."album_images/view_album_image/".$album_image->album_image_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR."album_images/restore/".$album_image->album_image_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR."album_images/delete/".$album_image->album_image_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
