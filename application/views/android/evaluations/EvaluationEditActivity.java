...
public class EvaluationEditActivity extends AppCompatActivity {
	...
	private EditText academical_evaluation_id;
				...
				private Button btn_update_evaluations;
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		academical_evaluation_id = (EditText)findViewById(R.id.academical_evaluation_id);
				...
				btn_edit_evaluations = (Button)findViewById(R.id.btn_update_evaluations);
		...
		RequestQueue request_queue = Volley.newRequestQueue(EvaluationEditActivity.this);
		StringRequest request = new StringRequest(Request.Method.POST, SERVER_URL+"/mobile/evaluation/view_evaluation/"+id, new Response.Listener<String>() {
								@Override
								...
								for(int i=0; i<=JsonArray.length(); i++){
									...
									academical_evaluation_id.setText(json_object.getString("academical_evaluation_id"));
				class_id.setText(json_object.getString("class_id"));
				section_id.setText(json_object.getString("section_id"));
				subject_id.setText(json_object.getString("subject_id"));
				kpi_id.setText(json_object.getString("kpi_id"));
				rate.setText(json_object.getString("rate"));
				teacher_name.setText(json_object.getString("teacher_name"));
				evaluator.setText(json_object.getString("evaluator"));
...
btn_update_evaluations.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              final String form_academical_evaluation_id = academical_evaluation_id.getText().toString();
				...
				RequestQueue request_queue = Volley.newRequestQueue(EvaluationAddActivity.this); 
				 StringRequest request = new StringRequest(Request.Method.POST, url+"/mobile/evaluation/save_data/"+form_evaluation_id, new Response.Listener<String>() {
								@Override
								public void onResponse(String server_response) {
