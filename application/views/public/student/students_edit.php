...
<div class="row"> 
  ...
  display: inline-block;
                ...
                <span class="dot" style="background:<?php echo $section_name  ?>;  "></span><?php echo $section_name ?></h3>
            </div>
  ...
  ?>
                    ...
                    <input style="width:40px !important" type="text" name="student_class_no" value="" id="student_class_no" class="" style="" required="required" title="Class No" placeholder="Class No"></td>
			  ...
			  ?>
                ...
                <td><!-- <a class="btn btn-danger btn-sm" onclick="return confirm('are you sure? may remove student over data?')" href="<?php echo site_url(ADMIN_DIR."students/remove_student/$exam_id/$class_id/$section_id/$class_subject_id/$subject_id/$student->student_id") ?>" >Remove student</a> -->
             ...
             <?php   } ?>
                  ...
                  <td><?php echo $student->student_class_no; ?>
                    <input style="width:30px !important" onkeyup="update_student_info('<?php echo $student->student_id; ?>')" id="student_class_no_<?php echo $student->student_id; ?>" type="number" name="student_class_no" value="<?php echo $student->student_class_no; ?>" /></td>
                  ...
                  <td><?php echo $student->student_name; ?>
                    <input onkeyup="update_student_info('<?php echo $student->student_id; ?>')" id="student_name_<?php echo $student->student_id; ?>" type="text" name="student_name" value="<?php echo $student->student_name; ?>" /></td>
...
<script>
      function update_student_info(student_id){
		...
		$.ajax({ 
				...
				data:{ student_admission_no: student_admission_no }}).done(function( msg ) {
					/*//alert(msg);  
											$("#message").html(msg);
											$("#message").fadeIn('slow');
											$("#message").delay(5000).fadeOut('slow');*/
