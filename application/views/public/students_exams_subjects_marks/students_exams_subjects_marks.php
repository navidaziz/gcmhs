...
<th><?php echo $this->lang->line('student_name'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
            ...
            <td>
                <?php echo $student_exam_subject_mark->student_name; ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url("students_exams_subjects_marks/view_student_exam_subject_mark/".$student_exam_subject_mark->student_exam_subject_mark_id."/".$this->uri->segment(4)); ?>"> View </a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
