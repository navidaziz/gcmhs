...
<th><?php echo $this->lang->line('subject_title'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            <td>
                <?php echo $class_subject->subject_title; ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url("class_subjects/view_class_subject/".$class_subject->class_subject_id."/".$this->uri->segment(4)); ?>"> View </a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
