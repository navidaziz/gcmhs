...
<th><?php echo $this->lang->line('exam_data'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            <td>
                <?php echo $exam->exam_data; ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url("exams/view_exam/".$exam->exam_id."/".$this->uri->segment(4)); ?>"> View </a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
