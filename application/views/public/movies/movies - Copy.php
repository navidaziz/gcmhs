  ...
  <div class="col-sm-12">
    <div class="page-header"> 
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="pull-right"> <a class="btn btn-primary btn-sm" href="<?php echo site_url(ADMIN_DIR."movies/add"); ?>"><i class="fa fa-plus"></i> <?php echo $this->lang->line('New'); ?></a> <a class="btn btn-danger btn-sm" href="<?php echo site_url(ADMIN_DIR."movies/trashed"); ?>"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('Trash'); ?></a> </div>
        </div>
      </div>
    </div>
  </div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo $movie->imdbURL; ?></td>
                <td><?php echo $movie->description; ?></td>
                <td><?php echo $movie->plot; ?></td>
                <td><?php echo $movie->location; ?></td>
                <td><a class="llink llink-view" href="<?php echo site_url("movies/view_movie/".$movie->movie_id."/".$this->uri->segment(4)); ?>"> View </a></td>
              </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
