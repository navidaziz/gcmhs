...
class Test_questions extends Admin_Controller
{
    ...
    public function add()
    {
        ...
        $this->data["title"] = $this->lang->line('Add New Test Questions');
        $this->data["view"] = ADMIN_DIR . "test_questions/add_test_questions";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
    ...
    public function edit($test_question_id)
    {
        ...
        $this->data["title"] = $this->lang->line('Edit Test Questions');
        $this->data["view"] = ADMIN_DIR . "test_questions/edit_test_questions";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
