...
class Exam_list extends Admin_Controller
{
	...
	function paper_collection_report($exam_id)
	{
		...
		foreach ($classes as $class) {
			...
			AND `subjects`.`subject_id` NOT IN(2,20,26)
  ...
  AND  `classes`.`class_id` = `students`.`class_id`
   AND `sections`.`section_id` = `students`.`section_id`
	...
	public function class_dmcs($exam_id, $class_id, $section_id, $order = NULL)
	{
		...
		$this->data["title"] = "Student Class Results";
		//$this->data["view"] = ADMIN_DIR . "exams/class_results";
		$this->load->view(ADMIN_DIR . "exams/results/class_dmcs", $this->data);
	}



	public function semester_result($exam_id, $class_id, $section_id, $order = NULL)
	{
		...
		$this->data["title"] = "Student Class Results";
		$this->data["view"] = ADMIN_DIR . "exams/class_results";
		$this->load->view(ADMIN_DIR . "exams/results/semester_result", $this->data);
	}
}
