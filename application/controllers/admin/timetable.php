...
";
 ...
 public function assign_teacher_subject_period(){
	 ...
	 public function update_week_value(){
		...
		$query_week=NULL;
		if($week_id=='mon') { $query_week='`mon`'; }
		if($week_id=='tue') { $query_week='`tue`'; }
		if($week_id=='wed') { $query_week='`wed`'; }
		if($week_id=='thu') { $query_week='`thu`'; }
		if($week_id=='fri') { $query_week='`fri`'; }
		if($week_id=='sat') { $query_week='`sat`'; }
		if($query_week){
