...
class Questions_answers extends Admin_Controller{
    ...
    $this->data["students"] = $this->question_answer_model->getList("STUDENTS", "student_id", "student_name", $where ="");
        ...
        $this->data["title"] = $this->lang->line('Add New Question Answer');$this->data["view"] = ADMIN_DIR."questions_answers/add_question_answer";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
    ...
    $this->data["students"] = $this->question_answer_model->getList("STUDENTS", "student_id", "student_name", $where ="");
        ...
        $this->data["title"] = $this->lang->line('Edit Question Answer');$this->data["view"] = ADMIN_DIR."questions_answers/edit_question_answer";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
