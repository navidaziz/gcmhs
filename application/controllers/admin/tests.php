...
class Tests extends Admin_Controller{
    ...
    $this->data["subjects"] = $this->test_model->getList("SUBJECTS", "subject_id", "subject_title", $where ="");
        ...
        $this->data["title"] = $this->lang->line('Add New Test');$this->data["view"] = ADMIN_DIR."tests/add_test";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
    ...
    $this->data["subjects"] = $this->test_model->getList("SUBJECTS", "subject_id", "subject_title", $where ="");
        ...
        $this->data["title"] = $this->lang->line('Edit Test');$this->data["view"] = ADMIN_DIR."tests/edit_test";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
